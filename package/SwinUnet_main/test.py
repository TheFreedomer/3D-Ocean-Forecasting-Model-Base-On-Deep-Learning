...
parser.add_argument("--split_name", default="measure", help="Directory of the input list")
...
def inference(args, model, test_save_path=None):
    ...
    logging.info("{} measure iterations per epoch".format(len(testloader)))
    model.eval()
    metric_list = 0.0
...
# python run_multiple_gpu.py --output_dir ./model_out/datasets --dataset datasets --cfg configs/swin_tiny_patch4_window7_224_lite.yaml --is_saveni --root_path /media/aicvi/11111bdb-a0c7-4342-9791-36af7eb70fc0/NNUNET_OUTPUT/nnunet_preprocessed/Dataset001_mm/measure --max_epoch 150 --base_lr 0.05 --img_size 224 --batch_size 24
