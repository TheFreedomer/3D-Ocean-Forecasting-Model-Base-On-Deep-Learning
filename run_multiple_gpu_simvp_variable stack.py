...
if __name__ == '__main__':
    ...
    # part
    depth_level = 39
    lst_variable_feature_ = ['tx', 'ty', 'ssr', 'str',
                             'ssh',
                             'u', 'v', 't', 's']
    lst_is_mask_feature_ = [False, False, False, False,
                            True,
                            True, True, True, True, ]
    lst_level_feature_ = [None, None, None, None,
                          None,
                          list(range(depth_level)), list(range(depth_level)),
                          list(range(depth_level)), list(range(depth_level))]
    idx_label_s = 4
    ...
    dim_level_cat_ = 'variable'     # sequence or variable
    ...
    for lead_ in lst_lead:
        ...
        # # log parameters
        log_dir_ = os.path.join(r'result/logs', 'variable_stack_' + str(lead_))
